[![Build Status](https://travis-ci.org/pqrs-org/cpp-osx-iokit_types.svg?branch=master)](https://travis-ci.org/pqrs-org/cpp-osx-iokit_types)
...
cget install pqrs-org/cpp-osx-iokit_types@v1.2.0 --cmake header
```
