...
template <>
struct hash<std::pair<pqrs::osx::iokit_hid_vendor_id, pqrs::osx::iokit_hid_product_id::value_t>> {
  size_t operator()(const std::pair<pqrs::osx::iokit_hid_vendor_id, pqrs::osx::iokit_hid_product_id::value_t>& pair) const {
    auto h1 = std::hash<int32_t>{}(type_safe::get(pair.first));
    auto h2 = std::hash<int32_t>{}(type_safe::get(pair.second));
    return h1 ^ (h2 << 16);
  }
...
template <>
struct hash<std::tuple<pqrs::osx::iokit_hid_vendor_id, pqrs::osx::iokit_hid_product_id::value_t, pqrs::osx::iokit_hid_location_id::value_t>> {
  size_t operator()(const std::tuple<pqrs::osx::iokit_hid_vendor_id, pqrs::osx::iokit_hid_product_id::value_t, pqrs::osx::iokit_hid_location_id::value_t>& tuple) const {
